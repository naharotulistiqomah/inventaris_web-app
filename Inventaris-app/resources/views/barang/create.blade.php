...
<div class="flex">
    ...
    <aside class="w-72 bg-white shadow-xl fixed h-full z-10 border-r border-blue-100 sidebar-scroll">
        ...
        <nav class="mt-6 px-4">
            ...
            <a href="/barang" class="nav-item flex items-center px-4 py-3  bg-blue-100 text-blue-800 font-medium">
                <i class="fas fa-plus-circle w-6 text-blue-500 mr-3 text-lg"></i>
    ...
    <div class="ml-72 flex-1">
                    ...
                    <div class="relative dropdown">
                        ...
                        <div class="dropdown-menu">
                            <div class="py-2">
                                ...
                                {{-- <a href="/logout" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 transition">
        ...
        <!-- Main content: Form Tambah Barang -->
        <main class="p-8">
            <div class="max-w-2xl mx-auto">
                <div class="form-card bg-white rounded-2xl border border-gray-200 p-8">
                    <div class="mb-6">
                        <h3 class="text-xl font-semibold text-gray-800">Form Input Barang</h3>
                        <p class="text-sm text-gray-500 mt-1">Silakan isi data barang di bawah ini.</p>
                    </div>
